...
function QuickNavCard({ to, icon: Icon, title, desc }: QuickNavCardProps) {
    return (
        <Link
            href={to}
            className="shadow-soft transition-silk border-border/70 bg-card hover:border-primary/60 group relative w-full overflow-hidden rounded-xl border p-5 backdrop-blur hover:-translate-y-0.5 md:w-auto md:flex-1 md:basis-0 lg:min-w-80"
        >

...
export default function AccountLoading() {
    return (
        <div className="md:min-w-lg mx-auto my-6 max-w-2xl rounded-lg bg-gray-800 px-4 py-12 sm:px-6 lg:px-8">
            {/* Title skeleton */}
            <Skeleton className="mx-auto mb-8 h-10 w-48 bg-gray-900" />

            <div className="w-full">
                {/* Tabs skeleton */}
                <div className="bg-linear-to-r grid w-full grid-cols-2 rounded-t-lg border-b border-gray-900 from-slate-900 via-gray-800 to-slate-900">

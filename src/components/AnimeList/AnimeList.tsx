...
export function AnimeList({
    ...
    return (
        <main className=" scrollbar-hide flex snap-x gap-4 overflow-x-auto px-4 py-6 md:grid md:grid-cols-2 md:gap-4 md:overflow-visible lg:grid-cols-3 xl:grid-cols-4">

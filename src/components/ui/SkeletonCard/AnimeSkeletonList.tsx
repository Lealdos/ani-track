...
export function AnimeListSkeleton({
    ...
    return (
        <section className="scrollbar-hide md:gap- snap-x gap-4 overflow-x-auto px-4 pb-4 md:grid md:grid-cols-3 md:overflow-visible lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-5">
